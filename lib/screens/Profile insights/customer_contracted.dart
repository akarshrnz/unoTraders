...
class CustomerContractedScreen extends StatefulWidget {
  const CustomerContractedScreen({super.key});

  @override
  State<CustomerContractedScreen> createState() => _ProfileVisitScreenState();
}

class _ProfileVisitScreenState extends State<CustomerContractedScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      profileInsightsProvider.getProfileVisitors(
          endPoints: Url.getCustomerscontacted);
    });
            ...
            : provider.ProfileVisitorsModelList.isEmpty &&
                ...
                : Column(
                    children: [
                      ...
                      // provider.isFetching &&
                      //         provider.hasNext &&
                      //         provider.ProfileVisitorsModelList.isNotEmpty
                      //     ? SizedBox(
                      //         height: 90,
