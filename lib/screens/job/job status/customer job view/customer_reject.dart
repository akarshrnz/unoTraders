...
import 'package:codecarrots_unotraders/screens/job/job%20status/customer%20job%20view/customer_job_card.dart';
...
class _LiveJobState extends State<CustomerReject> {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<GetAcceptRejectModel>>(
          future: JobServices.getCustomerJobAcceptReject(
              url: ApiServicesUrl.customerJobAcceptReject, status: "rejected"),
          builder:
