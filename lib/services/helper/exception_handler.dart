  ...
  void statusCodeHandler() {
    switch (statusCode) {
      ...
      case 403:
        ...
        break;
      case 404:
        returnMessage = message.isNotEmpty ? message : "404 Resource not Found";
        break;
      case 405:
        returnMessage = message.isNotEmpty ? message : "405 Method not allowed";
        break;
      case 429:
      ...
      case 504:
        returnMessage = message.isNotEmpty
            ? message
            : "504 Error occurred while Communication with Server";
        break;
      default:
