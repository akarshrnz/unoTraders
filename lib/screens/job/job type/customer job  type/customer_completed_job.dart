...
class CustomerCompleted extends StatefulWidget {
  const CustomerCompleted({Key? key}) : super(key: key);

  @override
  _LiveJobState createState() => _LiveJobState();
}

class _LiveJobState extends State<CustomerCompleted> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      jobProvider.fetchJobList(
          endPoint: Url.completedJob, jobStatus: "Completed");
    });
    super.initState();
  }
...
// class CustomerCompletedjob extends StatefulWidget {
//   const CustomerCompletedjob({Key? key}) : super(key: key);

//   @override
//   _LiveJobState createState() => _LiveJobState();
// }

// class _LiveJobState extends State<CustomerCompletedjob> {
//   TextEditingController serachcontroller = TextEditingController();
