...
class SeekQuoteListTraders extends StatelessWidget {
  final String id;
  final String category;
  const SeekQuoteListTraders({super.key, required this.id, required this.category});
                                ...
                                Navigator.push(
                                    ...
                                    PageTransition(
                                        ...
                                        child: TraderProfileVisit(
                                          id: data.id.toString(), category: category,
                                        )));
                              },
                              child: Card(
                                child: Column(
