...
import 'package:codecarrots_unotraders/screens/job/job%20status/trader%20job%20View/trader_job_card.dart';
...
class RejectedJob extends StatefulWidget {
  const RejectedJob({Key? key}) : super(key: key);

  @override
  _LiveJobState createState() => _LiveJobState();
}

class _LiveJobState extends State<RejectedJob> {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<GetAcceptRejectModel>>(
          future: JobServices.getTraderJobStatus(
              url: ApiServicesUrl.traderJobAcceptReject, status: 'rejected'),
          builder:
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ChangeNotifierProvider.value(
                          ...
                          //  JobCard(isUnpublished: false,onlyMoreDetails: true),
                          );
                    },
                  );
                } else {
