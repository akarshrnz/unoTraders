                      ...
                      itemBuilder: (context, index) => ExpansionTile(
                            title: Row(
                              children: [
                                ...
                                TextWidget(
                                  data: homeProvider.allCatList[index].category
                                      .toString(),
                            ...
                            children: <Widget>[
                              homeProvider.allCatList[index].subcategories ==
                                      null
                                  ? SizedBox()
                                  : ListView.builder(
                                      shrinkWrap: true,
                                      ...
                                      itemCount: homeProvider.allCatList[index]
                                                  .subcategories ==
                                              null
                                          ? 0
                                        ...
                                        return ListTile(
                                          ...
                                          title: Padding(
                                            padding: const EdgeInsets.symmetric(
                                                horizontal: 15),
                                            child: TextWidget(
                                              data: subData.category.toString(),
                                              style: const TextStyle(
                                                  fontWeight: FontWeight.w500),
                                            ),
                                          ),
