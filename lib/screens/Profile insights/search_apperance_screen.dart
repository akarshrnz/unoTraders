...
class SearchAppearanceScreen extends StatefulWidget {
  const SearchAppearanceScreen({super.key});

  @override
  State<SearchAppearanceScreen> createState() => _ProfileVisitScreenState();
}

class _ProfileVisitScreenState extends State<SearchAppearanceScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      profileInsightsProvider.getProfileVisitors(
          endPoints: Url.getSearchhistory);
    });
