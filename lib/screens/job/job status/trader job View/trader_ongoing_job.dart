...
class Ongoingjob extends StatefulWidget {
  const Ongoingjob({Key? key}) : super(key: key);

  @override
  _LiveJobState createState() => _LiveJobState();
}

class _LiveJobState extends State<Ongoingjob> {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<GetAcceptRejectModel>>(
          future: JobServices.getTraderJobStatus(
              url: ApiServicesUrl.traderJobOngoingCompleted, status: 'ongoing'),
          builder:
