...
class TraderOngoingJob extends StatefulWidget {
  const TraderOngoingJob({Key? key}) : super(key: key);

  @override
  _LiveJobState createState() => _LiveJobState();
}

class _LiveJobState extends State<TraderOngoingJob> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      infoProvider.traderJobTypeByStatus(
          url: Url.traderJobOngoingCompleted, status: 'ongoing');
    });
    super.initState();
  }
